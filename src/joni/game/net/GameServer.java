...
import joni.game.net.packets.Packet;
import joni.game.net.packets.Packet.PacketTypes;
import joni.game.net.packets.Packet00Login;
import joni.game.net.packets.Packet01Disconnect;
...
public class GameServer extends Thread {
	...
	private void parsePacket(byte[] data, InetAddress address, int port) {
		...
		case LOGIN:
			 ...
			 * game.level.addEntity(player); game.player = player; }
			 */
			break;
		case DISCONNECT:
